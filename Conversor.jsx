...
function ConversorDeMoedas() {
    ...
    useEffect(() => {
        fetch('http://api.exchangeratesapi.io/v1/latest?access_key=a68e859c2a33baef3522557d5b2c65fe&format=1')
    ...
    const converterMoeda = () => {
        fetch(`http://api.exchangeratesapi.io/v1/latest?access_key=a68e859c2a33baef3522557d5b2c65fe&format=1base=${deMoeda}&symbols=${paraMoeda}`)
            .then(response => response.json())
            .then(data => {
